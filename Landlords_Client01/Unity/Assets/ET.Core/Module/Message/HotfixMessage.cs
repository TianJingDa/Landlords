...
namespace ETModel {
  ...
  ///测试向服务器请求时间
  /// </summary>
  public partial class C2G_TestTime : pb::IMessage {
    private static readonly pb::MessageParser<C2G_TestTime> _parser = new pb::MessageParser<C2G_TestTime>(() => (C2G_TestTime)MessagePool.Instance.Fetch(typeof(C2G_TestTime)));
    public static pb::MessageParser<C2G_TestTime> Parser { get { return _parser; } }
  ...
  ///测试从服务器返回时间
  /// </summary>
  public partial class G2C_TestTime : pb::IMessage {
    private static readonly pb::MessageParser<G2C_TestTime> _parser = new pb::MessageParser<G2C_TestTime>(() => (G2C_TestTime)MessagePool.Instance.Fetch(typeof(G2C_TestTime)));
    public static pb::MessageParser<G2C_TestTime> Parser { get { return _parser; } }
